...
namespace ChatApp.Persistence.Migrations
{
    ...
    [Migration("20260216221203_EnhanceMessagesAndBlockUser")]
    partial class EnhanceMessagesAndBlockUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChatApp.Domain.Entities.BlockedUser", b =>
                {
                    b.HasOne("ChatApp.Domain.Entities.AppUser", "Blocked")
                        .WithMany()
                        .HasForeignKey("BlockedId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ChatApp.Domain.Entities.AppUser", "Blocker")
